...
public class AdminDao {
	...
	try {
		String sql = "INSERT INTO admins (admin_name, email, origin, birth_date, password) VALUES (?,?,?,?,?)";
...
*/
	...
	public static void update(String mail ,String name,String country, Date date) {
		...
		try {
			String sql = "Update admins Set admin_name=?, origin=?, birth_date=? Where email='"+mail+"'";
			pstmt = connection.prepareStatement(sql);
	...
	public static void ChangePass(String mail,String pass)
	{
		...
		try {
			String sql = "Update Admins set password=? Where email='"+mail+"'";
			pstmt = connection.prepareStatement(sql);
