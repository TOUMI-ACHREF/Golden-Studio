...
public class ProducerDao {
	...
	public static void add(Producer user) {
		PreparedStatement pstmt = null;
		// ResultSet rs = null;

		try {
			String sql = "INSERT INTO producers (producer_name, email, origin, birth_date, password) VALUES (?,?,?,?,?)";
	...
	public static boolean check(String email) {
		...
		String sql = "select * from producers where email='"+email+"'";
		try {
			pstmt = connection.prepareStatement(sql);
	...
	public static boolean login(String email,String password) {
		...
		String sql = "select * from producers where email='"+email+"' and password ='"+password+"'";
		try {
			pstmt = connection.prepareStatement(sql);
			ResultSet rs= pstmt.executeQuery(sql);
			return rs.next();
	...
	public static void update(String mail ,String country, Date date) {
		...
		try {
			String sql = "Update producers Set origin=?, birth_date=? Where email='"+mail+"'";
			pstmt = connection.prepareStatement(sql);
	...
	public static void ChangePass(String mail,String pass)
	{
		...
		try {
			String sql = "Update producers set password=? Where email='"+mail+"'";
			pstmt = connection.prepareStatement(sql);
